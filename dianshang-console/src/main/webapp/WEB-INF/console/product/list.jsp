...
<div class="body-box">
    <form action="/console/product/list.do" method="get" style="padding-top:5px;">
	...
	<span class="r inb_a page_b">
        ...
        <font size="2">上一页</font>
                ...
                <a href="list.do?name=${name}&isShow=${isShow}&pageNum=${pageProduct.pageNum-1}"><font
                        size="2">上一页</font></a>
    </c:if> &nbsp;
        ...
        <a href="list.do?name=${name}&isShow=${isShow}&pageNum=${pageProducts.pageNum+1}"><font size="2">下一页</font></a>
    </c:if> <a href="list.do?name=${name}&isShow=${isShow}&pageNum=${pageProducts.pages}"><font size="2">尾页</font></a> 共<var>${pageProducts.pages}</var>页 到第 <input
